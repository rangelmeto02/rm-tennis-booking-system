...
For security and privacy, the version published in this repository is a **portfolio demonstration** and does not connect to the live Firestore database.

Instead, it contains fictional sample lessons that allow employers and other visitors to explore the application's functionality safely.

---

## 🔐 Security Considerations

The current coach PIN system is a client-side demonstration and should not be considered production authentication.

A production version would replace this with a proper authentication system such as **Firebase Authentication**, together with appropriately restricted **Firestore Security Rules**.

Real customer information and live Firebase project configuration are intentionally excluded from this public repository.

This separation allows the application's functionality to be demonstrated without exposing private customer data or the working database.
...
Graduate student and tennis coach interested in software development, technology and building practical digital solutions to real-world problems.
